...
#define STRING_CONFIG_H_AUTHOR "ricky, kosselmini-based" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "EWE Industries Kossel"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 644.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -3.0, -3.0, -3.0 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 166.00 }  // default steps per unit for Kossel (GT2, 20 tooth)
